...
export default function BookLoadingSpinner({
 text = 'Loading...',
 size = 'md',
 showText = true,
 className,
 fullScreen = false,
}: BookLoadingSpinnerProps) {
 const sizeClasses = {
 sm: 'scale-50',
 md: 'scale-100',
 lg: 'scale-150',
 ...
 ? 'fixed inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#1a1a2e]'
 ...
 {/* Glow effect */}
 <div className="absolute w-[200px] h-[200px] -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2 bg-[radial-gradient(circle,rgba(167,139,218,0.2)_0%,transparent_70%)] rounded-full blur-[40px] -z-10" />
 ...
 <li key={i} style={{ '--page-index': i + 1 } as React.CSSProperties} />
 ))}
 </ul>
 </div>
 </div>
 ...
 {showText && (
 <span className="mt-8 text-[#a78bda] text-sm tracking-[2px] uppercase opacity-80">
 {text}
 </span>
 )}
 ...
 .book-pages li:nth-child(1) { animation-name: page-1; }
 .book-pages li:nth-child(2) { animation-name: page-2; }
 .book-pages li:nth-child(3) { animation-name: page-3; }
 .book-pages li:nth-child(4) { animation-name: page-4; }
 .book-pages li:nth-child(5) { animation-name: page-5; }
 .book-pages li:nth-child(6) { animation-name: page-6; }
 .book-pages li:nth-child(7) { animation-name: page-7; }
 .book-pages li:nth-child(8) { animation-name: page-8; }
 .book-pages li:nth-child(9) { animation-name: page-9; }
 .book-pages li:nth-child(10) { animation-name: page-10; }
 .book-pages li:nth-child(11) { animation-name: page-11; }
 .book-pages li:nth-child(12) { animation-name: page-12; }
 .book-pages li:nth-child(13) { animation-name: page-13; }
 .book-pages li:nth-child(14) { animation-name: page-14; }
 .book-pages li:nth-child(15) { animation-name: page-15; }
 .book-pages li:nth-child(16) { animation-name: page-16; }
 .book-pages li:nth-child(17) { animation-name: page-17; }
 .book-pages li:nth-child(18) { animation-name: page-18; }
 ...
 @keyframes book {
 4% { transform: rotateZ(90deg); }
 10%, 40% { transform: rotateZ(0deg); transform-origin: 30px 2px; }
 40.01%, 59.99% { transform-origin: 2px 2px; }
 46%, 54% { transform: rotateZ(-90deg); }
 60%, 90% { transform: rotateZ(0deg); transform-origin: 30px 2px; }
 96% { transform: rotateZ(90deg); }
 }
 `}</style>
 </div>
